...
| `10-yandex.lst` | 67 | Яндекс и Yango, включая CDN и рекламные домены |
...
| `10-blocked-ru-hosted.lst` | 44 | Заблокированные ресурсы на российском хостинге |
...
Источники два: реестр РКН, пересечённый с Tranco top-1M, и список
`Russia/inside-raw.lst` из itdoginfo/allow-domains.
